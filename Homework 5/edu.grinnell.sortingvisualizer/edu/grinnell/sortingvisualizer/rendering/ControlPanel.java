...
public class ControlPanel extends JPanel {
    ...
    private static final int FPS = 10; //20;
...
//                Integer[] temp = Arrays.copyOf(originalNotes, originalNotes.length);
                Integer[] temp = Arrays.copyOf(notes.getNotes(), notes.getNotes().length);
                    ...
                    public void run() {
                        if (index < events.size()) {
                            ...
                            while(i < affected.size()) {
                            	...
                            	System.out.println("In the while loop: " + Arrays.toString(notes.getNotes()));
                            	panel.repaint();
                            }
